                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="relative z-10 mt-1.5 flex h-3 w-3 shrink-0 items-center justify-center -translate-x-[2px]">
                                                    <div
                                                        className={`h-3 w-3 rounded-full border-2 bg-white dark:bg-zinc-950 ${isHard ? 'border-rose-500' : 'border-sky-500'
                                                            }`}
                                                    />
                                                </div>
                                                        ...
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <span
                                                                        className={`text-[10px] font-extrabold uppercase tracking-wider ${isHard
